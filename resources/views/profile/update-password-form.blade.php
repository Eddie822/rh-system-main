<x-form-section submit="updatePassword">
    ...
    <x-slot name="form">
        <div class="col-span-6 sm:col-span-4">
            <x-label class=" dark:text-gray-600" for="current_password" value="{{ __('Current Password') }}" />
        ...
        <div class="col-span-6 sm:col-span-4">
            <x-label class="dark:text-gray-600" for="password" value="{{ __('New Password') }}" />
            <x-input id="password" type="password" class="block w-full mt-1" wire:model="state.password" autocomplete="new-password" />
            <x-input-error for="password" class="mt-2" />
        </div>

        <div class="col-span-6 sm:col-span-4">
            <x-label class="dark:text-gray-600" for="password_confirmation" value="{{ __('Confirm Password') }}" />
