    ...
    <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <!-- Navigation Links -->
                <div
                    class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex text-stone-800 dark:bg-gray-800 dark:border-gray-700 dark:text-white">
                    <x-nav-link href="{{ route('request') }}" :active="request()->routeIs('requests')">
                        {{ __('Solicitudes') }}
                    </x-nav-link>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                <div class="flex items-center ms-3">
                    <button onclick="toggleDarkMode()"
                        class="p-2 text-gray-500 transition rounded-md hover:text-gray-700 dark:text-gray-300 dark:hover:text-white">
                        <!-- Ícono sol -->
                        <svg xmlns="http://www.w3.org/2000/svg" class="block w-6 h-6 dark:hidden" fill="none"
                        ...
                        <!-- Ícono luna -->
                        <svg xmlns="http://www.w3.org/2000/svg" class="hidden w-6 h-6 dark:block" fill="none"
                            viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
