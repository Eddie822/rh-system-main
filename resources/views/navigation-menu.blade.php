    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <!-- Navigation Links -->
                <div
                    class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex dark:bg-gray-800 dark:border-gray-700 dark:text-white">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                <div class="ms-3 flex items-center">
                    <button onclick="toggleDarkMode()"
                        class="p-2 rounded-md text-gray-500 hover:text-gray-700 dark:text-gray-300 dark:hover:text-white transition">
                        <!-- Ícono sol -->
                        ...
                        <!-- Ícono luna -->
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 hidden dark:block" fill="none"
                            viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
